...
namespace MaleficsTests.Models
{
    ...
    public class BoardTests
    {
        ...
        [TestCase("o")]
        [TestCase("r")]
        public void Invalid_Barricade_Placements(string board)
            => Assert.That(FromRows(board).IsLegalBarricadePlacement(new(0, 0)), Is.False);
        ...
        [Test]
        public void Moving_A_Pawn_Onto_A_Barricade_Returns_A_Barricade_Captured()
            => Assert.That(
                FromRows("r.o")
                    .MovePawn(
                        new(PlayerColor.Red),
        ...
        [Test]
        public void Moving_A_Pawn_Onto_A_Pawn_Of_Another_Color_Returns_That_Pawn_Captured()
            => Assert.That(
                FromRows("r.b")
                    .MovePawn(
                        new(PlayerColor.Red),
                        Path.AxisParallel(new(0, 0), new(2, 0))),
                Is.EqualTo(new PieceCaptured(new Pawn(PlayerColor.Blue))));
    }
}
